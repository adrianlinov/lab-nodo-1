...
class SX127x:
    ...
    # def __init__(self,
    #              name = 'SX127x',
    #              parameters = {'frequency': 434E6, 'tx_power_level': 2, 'signal_bandwidth': 125E3,
    #                            'spreading_factor': 7, 'coding_rate': 5, 'preamble_length': 8,
    #                            'implicitHeader': False, 'sync_word': 0x12, 'enable_CRC': True},
    #              onReceive = None):
    # TODO: Subir TX power a 13
        
    def __init__(self,
                name = 'SX127x',
                parameters = {'frequency': 434E6, 'tx_power_level': 5, 'signal_bandwidth': 125E3,
                            'spreading_factor': 9, 'coding_rate': 5, 'preamble_length': 8,
                            'implicitHeader': False, 'sync_word': 0x12, 'enable_CRC': True},
                onReceive = None):
    ...
    def packetRssi(self):
        return (self.readRegister(REG_PKT_RSSI_VALUE) - (164 if self._frequency < 915E6 else 157))
